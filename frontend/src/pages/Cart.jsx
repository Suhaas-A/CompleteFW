...
export default function Cart() {
  ...
  // Load cart when entering this page
  useEffect(() => {
    fetchCart();
  }, [fetchCart]);
    ...
    <div className="min-h-screen bg-[#F9F9F7] px-4 py-10">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-6 md:p-10">
        ...
        <button
          ...
          className="mt-8 w-full bg-gradient-to-r from-[#C9A227] to-[#8C6B1F] hover:from-[#D4AF37] hover:to-[#B8871F] text-white py-4 rounded-2xl font-semibold text-lg shadow-md hover:shadow-[0_0_12px_rgba(201,162,39,0.3)] transition-all duration-300"
        >
          Proceed to Checkout
        </button>
      </div>
